...
export async function POST(request: NextRequest) {
  try {
    ...
    const catData = { name, slug, description: description || '', contentIds: contentIds || [], createdAt: timestamp, updatedAt: timestamp }
    const docRef = await addDoc(collection(firestore, 'categories'), catData)
